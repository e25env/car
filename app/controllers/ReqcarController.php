    ...
    public function  view_reqcar( $id )
    {
    	if ( Session::get('level') == '1' || Session::get('level') == '2' ||Session::get('level') == '3' )
    	{
			...
			foreach ( $result as $key ) 
			{
				...
				$pdf->SetXY(26, 47);
				$pdf->MultiCell(180, 0, 'ข้าพเจ้า.......................................................ตำแหน่ง......................................................................ฝ่าย..................................................', 0, 'L', 0, 1, '', '', true);
				$pdf->SetFont('angsanaupc','B',13,'',true);
				$pdf->SetXY(37, 46);
				$pdf->MultiCell(45, 0, $key->req_name, 0, 'C', 0, 1, '', '', true);
				$pdf->SetXY(92, 46);
				$pdf->MultiCell(57, 0, $key->position, 0, 'L', 0, 1, '', '', true);
				$pdf->SetXY(155, 46);
				$pdf->MultiCell(40, 0, $key->department, 0, 'L', 0, 1, '', '', true);

				$pdf->SetFont('angsanaupc','B',14,'',true);
				$pdf->SetXY(15, 56);
				$pdf->MultiCell(181, 0, 'ขออนุญาตใช้รถไป(ไปที่ไหน).........................................................................................................................................................................', 0, 'L', 0, 1, '', '', true);
				//$pdf->SetFont('angsanaupc','',14,'',true);
				$pdf->SetXY(60, 55);
				$pdf->MultiCell(135, 0, $key->location, 0, 'L', 0, 1, '', '', true);

				//$pdf->SetFont('angsanaupc','',14,'',true);
				$pdf->SetXY(15, 65);
				$pdf->MultiCell(181, 0, 'เพื่อ.....................................................................................................................................................................................................................', 0, 'L', 0, 1, '', '', true);
				//$pdf->SetFont('angsanaupc','',14,'',true);
				$pdf->SetXY(24, 64);
