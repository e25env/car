	...
	<div class="uk-overflow-container">
		...
		<tbody>		
			...
			<tr class="uk-table-middle">			
				...
				<?php if( Session::get('level') == 1 || Session::get('level') == 2 || Session::get('level') == 3 ){ ?>	
				<td width="30"><a data-uk-tooltip title="พิมพ์รายละเอียด" class="<?php echo ($a->req_status==2)?'closebtn':'' ?> uk-button uk-button-success" target="_blank" href="{{ URL::to('reqcar/view') }}/{{ $a->req_car_id }}"><i class="uk-icon-print"></i></a></td>			
...
<?php 
	...
	//echo $data->appends(['search' => Input::get('search')])->render();
